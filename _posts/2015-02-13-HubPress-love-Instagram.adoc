...
If you are an http://instagram.com[Instagram] user, you can easily add your photos in your blog post.
...
And then paste it in HubPress and surround it with 4 + :
...
Have fun with http://hubpress.io[HubPress]!